...
@section("content")
<div id="fh5co-title-box" style="background-image: url({{ asset('assets/images/camila-cordeiro-114636.jpg') }}); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Related</div>
        </div>
