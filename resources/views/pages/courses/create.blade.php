            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 px-4 px-sm-auto">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control cf-input" name="name" placeholder="Course name" aria-label="Email" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div>
                        <button type="button" class="w-100 cf-button mt-3">Add course</button>
                    </div>
                </div>
            </div>
        </div>
